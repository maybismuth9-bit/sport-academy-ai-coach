...
const translations: Translations = {
  ...
  "physio.subtitle": { en: "AI-powered recovery guidance & exercises", he: "הכוונה לשיקום ותרגילים מבוססי AI", es: "Guía de recuperación y ejercicios con IA", zh: "AI驱动的恢复指导与练习", ar: "إرشادات تعافي وتمارين بالذكاء الاصطناعي", de: "KI-gestützte Erholungsberatung & Übungen" },
  ...
  "physio.diagnose": { en: "Find Exercises For Me", he: "מצא לי תרגילים", es: "Encuentra ejercicios para mí", zh: "为我找练习", ar: "ابحث لي عن تمارين", de: "Finde Übungen für mich" },
  "physio.analyzing": { en: "Analyzing...", he: "מנתח...", es: "Analizando...", zh: "分析中...", ar: "جاري التحليل...", de: "Analysiere..." },
  "physio.results": { en: "RECOMMENDATIONS", he: "המלצות", es: "RECOMENDACIONES", zh: "建议", ar: "التوصيات", de: "EMPFEHLUNGEN" },
  ...
  "physio.newDiagnosis": { en: "New Check", he: "בדיקה חדשה", es: "Nueva consulta", zh: "新检查", ar: "فحص جديد", de: "Neue Prüfung" },
